...
impl TfFrameArr{
    ...
    //pub fn reconfig_with_convert(&mut self, frsqif_computing: &FrSqIFCompute, freq_detail_hz: Option<f32>, freq_detail_period_sec: Option<f32>, time_kvant_samples: Option<usize>, time_kvant_seconds: Option<f32>){
    //    todo!()
    //}
    //pub fn plot(){
    //    todo!()
