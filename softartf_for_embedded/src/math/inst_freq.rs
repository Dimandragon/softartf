...
pub fn inst_freq(arr: &mut [Complex<f32>], out: &mut [f32], sample_freq: f32, fft: fn(&mut[Complex<f32>]), ifft: fn(&mut[Complex<f32>])) {
    ht(arr, fft, ifft);
...
pub fn inst_freq_ampl(arr: &mut [Complex<f32>], out_freq: &mut [f32], out_ampl: &mut [f32], sample_freq: f32, fft: fn(&mut[Complex<f32>]), ifft: fn(&mut[Complex<f32>])){
    ht(arr, fft, ifft);
...
pub fn inst_ampl(arr: &mut [Complex<f32>], out_ampl: &mut [f32], fft: fn(&mut[Complex<f32>]), ifft: fn(&mut[Complex<f32>])){
    ht(arr, fft, ifft);
    out_ampl[0] = num_traits::float::Float::sqrt(arr[0].re.powi(2) + arr[0].im.powi(2));
    for i in 1..arr.len(){
        out_ampl[i] = num_traits::float::Float::sqrt(arr[i].re.powi(2) + arr[i].im.powi(2));
