...
use crate::structs::FrSqIFCompute::InstFreqTypeForResampling;

pub enum LenFilterDraftOption{
    Minimum,
    Average,
    Median,
}
...
impl FIFCompute{
    pub fn new(fft_in: fn(&mut[Complex<f32>], &mut[Complex<f32>]))->FIFCompute{
        FIFCompute {
            signal: PaddedSignalComplex::new(fft_in),
